  ...
  return (
    <div className="flex max-w-[512px] flex-col">
      ...
      <div className="my-8 flex flex-col items-center">
        ...
        <h1 className="mt-4 text-xl xs:text-2xl sm:text-3xl">Forgot Password?</h1>
      </div>

      <p className="mb-4">
        Enter the email used for your account below and a password reset email will be sent to that
        address.
      </p>
