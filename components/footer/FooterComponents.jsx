...
export function FooterSubHeading({ children }) {
  return <h4 className="my-2 text-lg">{children}</h4>
}
...
export function FooterDiscordLink() {
  return (
    <a href={DISCORD_LINK} target="_blank" rel="noopener noreferrer">
      <svg
        className="mr-2 fill-fg-secondary hover:fill-theme"
...
export function FooterTwitterLink({ isPersonal }) {
  return (
    <a
      href={isPersonal ? RYAN_TWITTER_LINK : TWITTER_LINK}
      target="_blank"
...
export function FooterCopyright() {
  return (
    <p className="w-full text-center text-sm font-light lg:w-auto lg:text-left">
