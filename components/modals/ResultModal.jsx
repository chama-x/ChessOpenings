    ...
    <Modal title="Contribute" onClose={() => setShowResultModal(false)}>
      {result?.id ? (
        <div className="flex flex-col">
          <h2 className="mb-4 text-xl">Submission Successful</h2>
          <p className="mb-4">
            It will now be reviewed by an admin and either accepted or rejected.
          </p>
          <p className="mb-4">
            Here is a permanent link to your submission so you can track its progress. Copy it down
            somewhere safe:
          </p>

          <div className="mb-4 rounded-md bg-tertiary p-2 text-center">
            {`https://chessopenings.co.uk/submissions/${result.id}`}
          </div>
          <div className="mx-auto mb-4" onClick={() => setCopied(!copied)}>
            <Button>
          ...
          <p className="mb-4">
            Keep track of your submissions easier and see Admin comments by joining the
            ChessOpenings Discord Server. Click the Discord logo below to join!
          </p>
          <a
          ...
          <div className="mb-4 mt-8 flex justify-evenly">
        ...
        <div className="flex flex-col">
          <h2 className="mb-4 text-xl">Submission Failed</h2>
